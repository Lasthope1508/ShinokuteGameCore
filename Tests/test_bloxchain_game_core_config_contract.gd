...
func _init() -> void:
	...
	passed = passed and _assert_true(manifest_raw.contains(CONFIG_PATH), "Runtime manifest should include BloxChain GameCoreConfig")
	passed = passed and _assert_true(manifest_raw.contains("res://shared/ShinokuteGameCore/addons/shinokute_game_core/core/game_core_config.gd"), "Runtime manifest should include shared GameCoreConfig script")
