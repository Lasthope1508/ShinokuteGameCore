	...
	if scene != null and theme != null:
		var cases := [
			...
			},
			{
				...
				"board": Rect2(404.65288, 156.00024, 470.69424, 470.69424),
				"backplate": Rect2(389.5296, 140.99976, 500.9408, 500.81832)
			},
			{
				"mode": "light",
				"size": Vector2(720, 1280),
			...
			},
			{
				"mode": "light",
				"size": Vector2(1280, 720),
				"board": Rect2(422.176, 165.30768, 421.89312, 421.89312),
				"backplate": Rect2(408.67456, 151.80696, 448.89472, 448.8948)
			}
		]
