...
exports.getlocation = onRequest({ cors: true }, (req, res) => {
  const rawCountry = req.headers["x-country-code"] || req.headers["x-appengine-country"] || "VN";
  ...
  if (countryData[countryCode]) {
    ...
    continentCode = countryData[countryCode][1];
  }
  
  logger.info(`Detected location request: ${countryCode} -> ${countryName} (${continentCode})`);
