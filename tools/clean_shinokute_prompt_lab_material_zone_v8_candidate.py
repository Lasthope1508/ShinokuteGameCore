...
def main() -> None:
    ...
    mats = {
        "skin": make_mat("Shinokute_V8_Skin_From_Mask", (0.92, 0.69, 0.50, 1.0)),
        "hair": make_mat("Shinokute_V8_Hair_Black", (0.008, 0.009, 0.010, 1.0)),
        "hoodie": make_mat("Shinokute_V8_Hoodie_Black", (0.020, 0.023, 0.026, 1.0)),
        "shorts": make_mat("Shinokute_V8_Shorts_Black", (0.012, 0.013, 0.015, 1.0)),
        "socks": make_mat("Shinokute_V8_Socks_Black", (0.006, 0.007, 0.008, 1.0)),
    }
    mat_index = {}
    ...
    for poly in mesh.data.polygons:
        ...
        front_depth = y <= 0.290
        face = 0.745 <= z <= 0.890 and 0.300 <= x <= 0.700 and front_depth and (normal.y < -0.10 or abs(normal.x) > 0.34)
        neck = 0.685 <= z < 0.755 and 0.425 <= x <= 0.575 and y <= 0.220 and normal.y < -0.08
    ...
    mesh["shinokute_cleanup_source"] = "prompt lab material zone v8: material-ID/SSOT solid zones over prompt-lab projection"
            ...
            json.dumps(
                {
                    ...
                    "method": "prompt-lab albedo projection plus material-ID/SSOT solid cleanup zones",
                },
                indent=2,
            ),
            encoding="utf-8",
