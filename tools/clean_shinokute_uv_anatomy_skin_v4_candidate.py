...
def main() -> None:
    ...
    skin = mat("Shinokute_Anatomy_Skin_V4", (0.64, 0.48, 0.36, 1.0))
    sock = mat("Shinokute_Sock_Black_V4", (0.012, 0.013, 0.015, 1.0))
    ...
    for poly in mesh.data.polygons:
        ...
        # Wider than v3. Stops below shorts, starts above sock/boot band.
        legs = 0.178 <= z <= 0.365 and ((0.18 <= x <= 0.49) or (0.51 <= x <= 0.82))
        socks = 0.100 <= z < 0.178 and ((0.20 <= x <= 0.48) or (0.52 <= x <= 0.80))
    ...
    mesh["shinokute_cleanup_source"] = "anatomy skin v4: wider legs, narrow face/neck"
