...
OUT = ROOT / "assets" / "themes" / "candy_sky_islands" / "models" / "character_shinokute_hunyuan_mv_anatomy_candidate.glb"
REPORT = ROOT / "assets" / "themes" / "candy_sky_islands" / "source" / "shinokute_player" / "shinokute_hunyuan_mv_anatomy_candidate_report.json"
...
def main() -> int:
    inputs = {
        ...
        "left": POOL / "shinokute_anatomy_left_side.png",
    ...
    mesh = pipeline(
        ...
        num_chunks=16000,
        generator=torch.manual_seed(54321),
        output_type="trimesh",
    )[0]
    ...
    report = {
        ...
        "octree_resolution": 256,
        "num_chunks": 16000,
        "source": "9Router Hunyuan-anatomy corrected sheet -> Photoroom full sheet -> polygon component extracted views",
